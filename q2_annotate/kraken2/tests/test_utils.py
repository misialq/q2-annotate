...
from q2_annotate.kraken2.utils import _process_kraken2_arg, _find_lca, _join_ranks
...
class TestKraken2Utils(TestPluginBase):
    ...
    def test_join_ranks_full(self):
        ranks = ["d__", "k__", "p__", "c__", "o__", "f__", "g__", "s__", "ssp__"]
